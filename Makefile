#############################################################################
# Makefile for building: MC_2D_NpT-VS_BinaryDiscSystem
# Generated by qmake (3.0) (Qt 5.7.0)
# Project:  MC_2D_NpT-VS_BinaryDiscSystem.pro
# Template: app
# Command: /home/mbilly/Qt5.7.0/5.7/gcc_64/bin/qmake -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile MC_2D_NpT-VS_BinaryDiscSystem.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = MC_2D_NpT-VS_BinaryDiscSystem1.0.0
DISTDIR = /home/mbilly/Programy/MC_2D_NpT-VS_BinaryDiscSystem/.tmp/MC_2D_NpT-VS_BinaryDiscSystem1.0.0
LINK          = g++
...
SOURCES       = MTGenerator.cpp \
		MC-NpT_2D_VariableBoxShape_BinaryDiscSystem.cpp 
OBJECTS       = MTGenerator.o \
		MC-NpT_2D_VariableBoxShape_BinaryDiscSystem.o
DIST          = ../../Qt5.7.0/5.7/gcc_64/mkspecs/features/spec_pre.prf \
		...
		MC_2D_NpT-VS_BinaryDiscSystem.pro MTGenerator.h MTGenerator.cpp \
		MC-NpT_2D_VariableBoxShape_BinaryDiscSystem.cpp
QMAKE_TARGET  = MC_2D_NpT-VS_BinaryDiscSystem
DESTDIR       = 
TARGET        = MC_2D_NpT-VS_BinaryDiscSystem
...
Makefile: MC_2D_NpT-VS_BinaryDiscSystem.pro ../../Qt5.7.0/5.7/gcc_64/mkspecs/linux-g++/qmake.conf ../../Qt5.7.0/5.7/gcc_64/mkspecs/features/spec_pre.prf \
		../../Qt5.7.0/5.7/gcc_64/mkspecs/common/unix.conf \
		../../Qt5.7.0/5.7/gcc_64/mkspecs/common/linux.conf \
		../../Qt5.7.0/5.7/gcc_64/mkspecs/common/sanitize.conf \
		../../Qt5.7.0/5.7/gcc_64/mkspecs/common/gcc-base.conf \
		...
		../../Qt5.7.0/5.7/gcc_64/mkspecs/features/yacc.prf \
		../../Qt5.7.0/5.7/gcc_64/mkspecs/features/lex.prf \
		MC_2D_NpT-VS_BinaryDiscSystem.pro \
		../../Qt5.7.0/5.7/gcc_64/lib/libQt5Core.prl
	$(QMAKE) -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile MC_2D_NpT-VS_BinaryDiscSystem.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents MTGenerator.cpp MC-NpT_2D_VariableBoxShape_BinaryDiscSystem.cpp $(DISTDIR)/
...
MC-NpT_2D_VariableBoxShape_BinaryDiscSystem.o: MC-NpT_2D_VariableBoxShape_BinaryDiscSystem.cpp MTGenerator.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o MC-NpT_2D_VariableBoxShape_BinaryDiscSystem.o MC-NpT_2D_VariableBoxShape_BinaryDiscSystem.cpp
